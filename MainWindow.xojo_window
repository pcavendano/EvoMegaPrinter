...
Begin DesktopWindow MainWindow
   ...
   Begin DesktopTabPanel StagePanel
      ...
      Begin DesktopTextField RedirectField
         ...
         TabPanelIndex   =   3
         TabStop         =   True
         Text            =   "https://localhost:8888/callback"
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   91
      ...
      Begin DesktopTextField ClientIDField
         ...
         TabPanelIndex   =   3
         TabStop         =   True
         Text            =   "3a47cd79a45e61852c5d9e9c750098383f0518a0dfe6832bddde5695f3a78917"
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   58
      ...
      Begin DesktopLabel Label2
         ...
         Width           =   71
      End
      Begin DesktopTextField ClientIDField1
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
         ...
         TabPanelIndex   =   3
         TabStop         =   True
         Text            =   "b4839e3a8cac7f30592b5961e823b0dd71497572ade6a1e7f782767827fa6a9c\r\n"
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   159
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Function BuildAuthorizeUrl(ClientID As String, State As String, URL As String, Redirect_URI As String = "https://localhost:8888/callback", Scope As String = "restlet") As String
		  
		  // Build Authorize URL
		  Var Result As String = URL + "?" _
		  + "scope=" + Scope _
		  + "&redirect_uri=" + EncodeURLComponent(Redirect_URI) _
...
#tag Events GenerateLinkButton
	#tag Event
		Sub Pressed()
		  ...
		  // Documentation
		  // https://suiteanswers.custhelp.com/app/answers/detail/a_id/91339
		  Var URL As String = BuildAuthorizeUrl(ClientIDField.Text, StateField.Text, "https://4500099-sb1.app.netsuite.com/app/login/oauth2/authorize.nl", RedirectField.Text, "restlets+rest_webservices+suite_analytics")
...
#tag Events AuthorizeButton
	#tag Event
		Sub Pressed()
		  ...
		  If Not Result.BeginsWith("https://localhost:8888/callback") Then
		    MessageBox("Netsuite returned an error " + Result)
		    Return
		  End If
...
#tag Events RetrieveTokensButton
	#tag Event
		Sub Pressed()
		  ...
		  + "&redirect_uri=https://localhost:8888/callback" _
		  + "&code_verifier=" + CodeVerifier
		  ExchangeConnection.SetRequestContent(Body, "application/x-www-form-urlencoded")
		  ExchangeConnection.Send("POST", "https://4500099-sb1.suitetalk.api.netsuite.com/services/rest/auth/oauth2/v1/token")
...
#tag Events GenerateExchangeURLButton
	#tag Event
		Sub Pressed()
		  ...
		  + "&redirect_uri=https://localhost:8888/callback" + EndOfLine _
		  + "&code_verifier=" + CodeVerifier
